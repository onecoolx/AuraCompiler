...
- **PARTIAL** Preprocessor macro operators (subset): `#` (stringize) and `##` (token paste, incl. best-effort rescan of pasted result) — `tests/test_preprocessor_macro_operators.py`, `tests/test_preprocessor_macro_token_paste_rescan.py`
