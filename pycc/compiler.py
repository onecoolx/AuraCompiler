...
class Compiler:
    ...
    def _preprocess_with_system_cpp(self, source_file: str) -> str:
        ...
        cmd += [
            ...
            # GCC math builtins used by math.h / float.h
            "-D__builtin_nanf(x)=(0.0/0.0)",
            "-D__builtin_nan(x)=(0.0/0.0)",
            "-D__builtin_huge_val()=(1.0/0.0)",
            "-D__builtin_huge_valf()=(1.0/0.0)",
            "-D__builtin_inff()=(1.0/0.0)",
            "-D__builtin_inf()=(1.0/0.0)",
            "-D__builtin_isnan(x)=((x)!=(x))",
            "-D__builtin_isinf(x)=((x)-(x)!=(x)-(x))",
            "-D__builtin_isinf_sign(x)=((x)-(x)!=(x)-(x))",
            "-D__builtin_isfinite(x)=((x)==(x)&&(x)-(x)==0.0)",
            "-D__builtin_signbit(x)=((x)<0)",
            "-D__builtin_signbitf(x)=((x)<0)",
            "-D__builtin_signbitl(x)=((x)<0)",
